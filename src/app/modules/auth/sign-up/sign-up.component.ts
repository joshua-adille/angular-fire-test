            ...
            .subscribe((response) =>
                {
                    switch(response._type) {
                        ...
                        case 'success': {
                            ...
                            // *** Proceed to confirmation, still need to design.
                            // Current bevavior navigates to the dashboard.
                        ...
                        case 'error': {
                            ...
                            response.code === 'email-already-registered'
                            ...
                            this.alert = {
                                type   : 'error',
                                message: response.code === 'email-already-registered'
