...
export const policies: PolicyApiType[] = [
    {
        id         : '6a5726e8-c467-45ea-92ab-d83235a06405',
        insurerId  : 'Baloise',
        price      : 1254.50,
        ...
        policyNumber: '1.234.554.665',
        timespanCode: '12MO',
        thumbnail: "assets/images/apps/ecommerce/policies/baloise.png",
        object: 'BMW 330 ‘17'
    },
    {
        id: "4195ee10-3f4e-4dd4-8c7d-a7a88bb8be31",
        insurerId: "AXA",
        price: 4354.46,
        statusCode: "EXPIRED",
        insuranceTypeCode: "ACCIDENT",
        policyNumber: "1.235.556.1",
        timespanCode: "24MO",
        thumbnail: "assets/images/apps/ecommerce/policies/axa.svg",
        object: "Apartment Rodeo Road 12 Zürich"
      }, {
        id: "f405c02c-c8c0-4289-973b-a97c677b8485",
        insurerId: "Assura",
        price: 3371.03,
        statusCode: "IN_EXTRACTION",
        insuranceTypeCode: "HEALTH",
        policyNumber: "1.235.556.2",
        timespanCode: "12MO",
        thumbnail: "assets/images/apps/ecommerce/policies/assura.png",
        object: "BMW 330 ‘17"
      }, {
        id: "f6525915-a857-4140-b0e6-190b2f619125",
        insurerId: "AXA",
        price: 4716.43,
        statusCode: "ACTIVE",
        insuranceTypeCode: "ACCIDENT",
        policyNumber: "1.235.556.3",
        timespanCode: "24MO",
        thumbnail: "assets/images/apps/ecommerce/policies/axa.svg",
        object: "BMW 330 ‘17"
      }, {
        id: "e06b23bc-ffff-4027-84d7-175d77acb7ef",
        insurerId: "Swiss Life",
        price: 1218.17,
        statusCode: "IN_EXTRACTION",
        insuranceTypeCode: "LIFE",
        policyNumber: "1.235.556.4",
        timespanCode: "48MO",
        thumbnail: "assets/images/apps/ecommerce/policies/swisslife.svg",
        object: "Apartment Rodeo Road 12 Zürich"
      }, {
        id: "92e93fec-33df-449a-b8d8-a2f06c596020",
        insurerId: "Baloise",
        price: 3719.67,
        statusCode: "TERMINATED",
        insuranceTypeCode: "HOUSEHOLD",
        policyNumber: "1.235.556.5",
        timespanCode: "12MO",
        thumbnail: "assets/images/apps/ecommerce/policies/baloise.png",
        object: "BMW 330 ‘17"
      }, {
        id: "a6ddaa43-7067-40ae-90b2-0b630a6b6e24",
        insurerId: "Assura",
        price: 4887.79,
        statusCode: "TERMINATED",
        insuranceTypeCode: "HEALTH",
        policyNumber: "1.235.557.5",
        timespanCode: "12MO",
        thumbnail: "assets/images/apps/ecommerce/policies/assura.png",
        object: "Apartment Rodeo Road 12 Zürich"
      }, {
        id: "44cb4e36-52bd-44fa-9962-4932fe463025",
        insurerId: "Swiss Life",
        price: 2539.59,
        statusCode: "IN_EXTRACTION",
        insuranceTypeCode: "HOUSEHOLD",
        policyNumber: "1.235.556.6",
        timespanCode: "48MO",
        thumbnail: "assets/images/apps/ecommerce/policies/swisslife.svg",
        object: "BMW 330 ‘17"
      }, {
        id: "5050beb0-0f5f-4a91-ab71-c3c42b6b4c09",
        insurerId: "AXA",
        price: 4530.55,
        statusCode: "ACTIVE",
        insuranceTypeCode: "HOUSEHOLD",
        policyNumber: "1.235.556.7",
        timespanCode: "24MO",
        thumbnail: "assets/images/apps/ecommerce/policies/axa.svg",
        object: "Apartment Rodeo Road 12 Zürich"
      }, {
        id: "9b612691-d504-461b-98c5-3664aba3ff7c",
        insurerId: "Baloise",
        price: 3458.81,
        statusCode: "EXPIRED",
        insuranceTypeCode: "HEALTH",
        policyNumber: "1.235.556.8",
        timespanCode: "12MO",
        thumbnail: "assets/images/apps/ecommerce/policies/baloise.png",
        object: "BMW 330 ‘17"
      }, {
        id: "677a283c-7d09-410b-8fc4-339e8cf4857a",
        insurerId: "Swiss Life",
        price: 2403.21,
        statusCode: "TERMINATED",
        insuranceTypeCode: "HEALTH",
        policyNumber: "1.235.556.9",
        timespanCode: "48MO",
        thumbnail: "assets/images/apps/ecommerce/policies/swisslife.svg",
        object: "Apartment Rodeo Road 12 Zürich"
      }
